...
<body>
  ...
  <section id="sect1">
    ...
    $req = mysqli_query($cn, "SELECT * FROM utilisateur,message where utilisateur.id_user=message.id_user order by id_message DESC");
  ...
  <img src="images/' . $data['id_user'] . '.jpg" class="photo" width="30px" height="30px">';
    ...
    if (isset($_POST['envoyer']))
    {
      ...
      $date = date('Y-m-d');
      $heure = date('H:i');
      $req1 = mysqli_query($cn, "INSERT INTO message values ('$id', '$msg','$date','$heure')");
